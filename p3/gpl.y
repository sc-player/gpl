...
%token < int > T_INT_CONSTANT    "int constant"
%token < double > T_DOUBLE_CONSTANT "double constant"
%token < string > T_STRING_CONSTANT "string constant"
...
%token < int > T_FORWARD         "forward" // value is line number
...
%token T_FOR                 "for"
%token T_ELSE                "else"
%token < int > T_PRINT           "print" // value is line number
%token < int > T_EXIT            "exit" // value is line number
